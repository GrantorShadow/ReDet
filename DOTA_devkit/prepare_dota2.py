...
def parse_args():
	parser = argparse.ArgumentParser(description='prepare dota2')
	parser.add_argument('--srcpath', default='/home/dingjian/project/dota2')
	parser.add_argument('--dstpath', default=r'/home/dingjian/workfs/dota2-split-1024',
						help='prepare data')
...
def prepare(srcpath, dstpath):
	...
	DOTA2COCOTrain(os.path.join(dstpath, 'trainval1024'),
				   os.path.join(dstpath, 'trainval1024', 'DOTA2_trainval1024.json'), wordname_18, difficult='-1')
