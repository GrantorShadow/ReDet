...
def dota_task1_eval(work_dir, det_dir):
	...
	annopath = r'data/dota2/test/dota2_labelTxt/{:s}.txt'
	imagesetfile = r'data/dota2/test/testset.txt'
...
def parse_args():
	...
	parser.add_argument('--work_dir',
						default='/project/jmhan/AerialDetection/work_dirs/faster_rcnn_RoITrans_er50_fpn_1x_dota15_alignv2_C4')
