...
data_root = '/workfs/jmhan/dota2_1024_ms/'
img_norm_cfg = dict(
...
data = dict(
	...
	train=dict(
		type=dataset_type,
		ann_file=[data_root + 'trainval1024/DOTA2_trainval1024.json',
				  data_root + 'trainval1024_ms/DOTA2_trainval1024_ms.json'],
	...
	test=dict(
		type=dataset_type,
		ann_file=[data_root + 'test1024/DOTA2_test1024.json',
				  data_root + 'test1024_ms/DOTA2_test1024_ms.json'],
...
log_level = 'INFO'
work_dir = 'work_dirs/ReDet_re50_refpn_1x_dota2_ms'
load_from = None
resume_from = None
workflow = [('train', 1)]
